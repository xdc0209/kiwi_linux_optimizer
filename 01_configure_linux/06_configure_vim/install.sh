...
cp $BASE_DIR/.vim/colors/* $HOME/.vim/colors

mkdir -p $HOME/.vim/plugin
cp $BASE_DIR/.vim/plugin/* $HOME/.vim/plugin

[ -f $HOME/.vimrc ] && sed -i "/kiwi vim optimize start/,/kiwi vim optimize end/d" $HOME/.vimrc
cat $BASE_DIR/vim_optimize.vimrc >>$HOME/.vimrc
